...
int main(int argc, char **argv)
{
	...
	if (argc == 9)
	{
		if (atoi(argv[1]) && atoi(argv[1]) != 0 && !check_str_greather_intmax(argv[1]))
		...
		if (atoi(argv[2]) && atoi(argv[2]) != 0 && !check_str_greather_intmax(argv[2]))
		...
		if (atoi(argv[3]) && atoi(argv[3]) != 0 && !check_str_greather_intmax(argv[3]))
		...
		if (atoi(argv[4]) && atoi(argv[4]) != 0 && !check_str_greather_intmax(argv[4]))
		...
		if (atoi(argv[5]) && atoi(argv[5]) != 0 && !check_str_greather_intmax(argv[5]))
		...
		if (atoi(argv[6]) && atoi(argv[6]) != 0 && !check_str_greather_intmax(argv[6]))
		...
		if (atoi(argv[7]) && atoi(argv[7]) != 0 && !check_str_greather_intmax(argv[7]))
